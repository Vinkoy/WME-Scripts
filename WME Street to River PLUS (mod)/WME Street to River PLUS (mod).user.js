...
function streetToRiver_init() {
    ...
    W.accelerators.addAction("WME_SreetToRiver_doPOI", {group: 'default'});
    W.accelerators.events.register("WME_SreetToRiver_doPOI", null, hotKey);
    W.accelerators._registerShortcuts({ 'u' : "WME_SreetToRiver_doPOI"});
    ...
    function insertButtons() {
        ...
        var divGroup3 = $('<label><a href="https://www.W.com/forum/viewtopic.php?f=819&t=87931" target="_blank">Street to River+' + version + '</a></label>');
...
//            if (riverLandmark.attributes.categories[0] === "RIVER_STREAM")
    ...
    function isBetaEditor(){
        ...
        return wmeEditor==="editor-beta.W.com";
